...
<head>
    ...
    <title>SuperOnline | Productos</title>
        ...
        <div class="main ms-5">
            <div class="container">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a href="añadir_productos.php" class="btn btn-success">Añadir Productos</a>

                    <!-- Buscador -->
                    <input type="text" id="searchInput" class="form-control" placeholder="Buscar productos..." onkeyup="searchTable()" style="max-width: 300px;">
                </div>
                    ...
                    <table class="table table-striped table-bordered" id="productosTable">
                        ...
                        <tbody>
                            ...
                            while ($producto = mysqli_fetch_assoc($resultadoProductos)) {
                                ...
                                echo "<td>
            <a href='editar_productos.php?id_producto=" . $producto['id_producto'] . "' class='btn btn-primary me-2'>Editar</a>
            <a href='eliminar_productos.php?id_producto=" . $producto['id_producto'] . "' class='btn btn-danger'>Eliminar</a>
          </td>";
                                echo "</tr>";
                            }
                            ?>
