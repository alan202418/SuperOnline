...
if (isset($_SESSION['user_name'])) {
    ...
    if ($resultadoUsuario->num_rows > 0) {
        ...
        $sqlProductos = "SELECT `id_usuario`, `nombre`, `apellido`, `email`, `usuario`, `contraseña`, `usuario_defecto`, `contraseña_defecto`, `rol` FROM `usuarios` WHERE rol = 'empleado' AND id_sucursal = ?";
        ...
        <div class="main ms-5">
            <div class="container">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a href="añadir_empleados.php" class="btn btn-success">Añadir Empleados</a>

                    <!-- Buscador -->
                    <input type="text" id="searchInput" class="form-control" placeholder="Buscar empleados..." onkeyup="searchTable()" style="max-width: 300px;">
                </div>
                    ...
                    <table class="table table-striped table-bordered" id="productosTable">
                        ...
                        <tbody>
                            ...
                            while ($producto = mysqli_fetch_assoc($resultadoProductos)) {
                                ...
                                echo "<td>" . htmlspecialchars($producto['usuario_defecto']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['contraseña_defecto']) . "</td>";
                                echo "<td>
        <div class='d-flex gap-2'>
          <a href='editar_empleados.php?id_usuario=" . $producto['id_usuario'] . "' class='btn btn-primary'>Editar</a>
          <a href='eliminar_empleados.php?id_usuario=" . $producto['id_usuario'] . "' class='btn btn-danger'>Eliminar</a>
        </div>
      </td>";
