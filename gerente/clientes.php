...
$sql = ("SELECT `id_usuario`, `nombre`, `apellido`, `email`, `usuario`, `contraseña`, `rol` FROM `usuarios` WHERE rol = 'cliente'");
...
<head>
    ...
    <title>SuperOnline | Clientes</title>
    ...
    <div class="wrapper">
        ...
        <div class="main ms-5">
            <div class="container">
                ...
                <!-- Buscador -->
                <div class="mb-3">
                    <input type="text" id="searchInput" class="form-control" placeholder="Buscar clientes..." onkeyup="searchTable()">
                </div>
