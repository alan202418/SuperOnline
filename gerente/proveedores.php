...
<head>
    ...
    <title>SuperOnline | Proveedores</title>
        ...
        <div class="main ms-5">
            <div class="container">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a href="añadir_proveedor.php" class="btn btn-success">Añadir proveedor</a>

                    <!-- Buscador -->
                    <input type="text" id="searchInput" class="form-control" placeholder="Buscar proveedor..." onkeyup="searchTable()" style="max-width: 300px;">
                </div>
                    ...
                    <table class="table table-striped table-bordered" id="productosTable">
                        ...
                        <tbody>
                            ...
                            while ($producto = mysqli_fetch_assoc($resultado)) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars($producto['id_proveedor']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['id_empresa']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['nombre']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['direccion']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['telefono']) . "</td>";
