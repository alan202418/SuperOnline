...
$sql = ("SELECT * FROM `pedido_retirado` WHERE id_sucursal = '$id_sucursal_usuario'");
...
<head>
    ...
    <title>SuperOnline | Pedidos Retirados</title>
    ...
    <style>
        ...
        #sidebar.expand .logo-img {
            display: block;
            max-width: 150px; /* Tamaño del logo cuando el menú está expandido */
            margin-left: 1rem;
            height: auto;
        }
                    ...
                    <table class="table table-striped table-bordered" id="productosTable">
                        ...
                        <tbody>
                            ...
                            while ($producto = mysqli_fetch_assoc($resultado)) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars($producto['id_retirado']) . "</td>";
                                ...
                                echo "<td>" . htmlspecialchars($producto['total']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['total_pagado']) . "</td>";
                                ...
                                echo "<td>" . htmlspecialchars($producto['fecha_retirado']) . "</td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
