...
<head>
    ...
    <title>SuperOnline | Devoluciones</title>
                    ...
                    <table class="table table-striped table-bordered" id="productosTable">
                        <thead class="table-dark">
                            <tr>
                                <th>ID</th>
                                <th>ID Compra</th>
                                <th>Alias/CBU del comprador</th>
                                <th>Total de devolucion</th>
                                <th>Estado de la devolucion</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            while ($producto = mysqli_fetch_assoc($resultado)) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars($producto['id_devolucion']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['id_compra']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['cuenta_destinatario']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['total_devolucion']) . "</td>";
                                echo "<td>" . htmlspecialchars($producto['estado_devolucion']) . "</td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
