...
<head>
    ...
    <title>SuperOnline | Como retirar mi Producto</title>
...
<body>
    ...
    <main class="container mt-5">
        <div class="animated-content">
            <h1>Para retirar tus productos deberá seguir los siguientes pasos</h1><br>
            <p>Paso 1: Verifique el estado de su pedido en la sección de "Mis compras".</p>
            <p>Paso 2: Recibirá un correo electrónico con la confirmación de que su pedido está listo para ser retirado.</p>
            <p>Paso 3: Diríjase a la sucursal que seleccionó para retirar.</p>
            <p>Paso 4: Presente el código de Barras, lo cual se muestra en la sección "Mis compras" y en "Ver más" para agilizar el proceso de retiro:</p>
            <svg id="barcode"></svg>
            <p>Paso 5: ¡Listo! Disfrute de sus productos comprados.</p>
        </div>
    </main>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            }, 200); // Retraso para que la animación sea más visible
        });
    </script>
