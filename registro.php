...
if(!empty($_POST)){
    ...
    if(esNulo([$nombre, $apellido, $email, $usuario, $contraseña])){
    ...
    if(count($error) == 0){
      $pass_hash = password_hash($contraseña, PASSWORD_DEFAULT);
        $id = registrarCliente([$nombre, $apellido, $email, $usuario,$pass_hash], $con);
...
<head><script src="/docs/5.3/assets/js/color-modes.js"></script>
  ...
  <title>SuperOnline | Registracion</title>
...
@media (max-width: 767px) {
  .imagenes {
    max-width: 28%; /* Ajusta según tus necesidades */
  }
}
      ...
      <style>
        ...
        .nav-link {
          color: black; /* Enlace negro por defecto */
        }
        /* Estilos para el botón "Categorías" al activarse */
  .dropdown-toggle.active {
    color: red; /* Texto rojo al activarse */
  }
        ...
        .dropdown-item {
          color: black; /* Texto negro para los elementos de lista */
        }
...
a:active {
  text-decoration: none;
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="login.php" > 
        <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: 15px;" width="24" height="24" fill="currentColor" class="text-black" class="bi bi-person-fill" viewBox="0 0 16 16">
