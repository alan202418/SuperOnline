        ...
        <div class="main p-3">
            <div class="text-center">
                ...
                <div class="card text-center mt-4 shadow">
                    <div class="card-body">
                        <h4 class="card-title">Bienvenido a SuperOnline</h4>
                        <p class="card-text">
                            ¡Nos alegra tenerte aquí! SuperOnline es tu sistema integral para gestionar todas las áreas de tu empresa. Desde aquí podrás controlar el inventario, supervisar ventas, gestionar empleados, y mantenerte al día con el rendimiento de tus sucursales.
                        </p>
