...
if ($id == '' || $token == '') {
  ...
  if ($token == $token_tmp) {
    ...
    if ($sql->fetchColumn() > 0) {
      $sql = $con->prepare("SELECT nombre, descripcion, precio, descuento, imagen FROM productos WHERE id_producto=?  LIMIT 1");
      $sql->execute([$id]);
      ...
      <div class="row">
        ...
        <div class="col-md-6 order-md-2">
          ...
          <div class="d-grid gap-3 col-10 mx-auto">
            ...
            <button class="btn btn-outline-success" type="button" onclick="window.location.href='electrodomesticos.php'">Ver más de este Producto <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-bag-plus-fill" viewBox="0 0 16 16">
